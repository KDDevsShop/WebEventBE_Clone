...
//Admin routes
router.post("/", validateToken,  validateAdmin, upload.single("image"), createRoomController);
router.put("/:id", validateToken, validateAdmin, upload.single("image"),updateRoomController);
router.delete("/:id", validateToken, validateAdmin, deleteRoomController);
router.patch("/:id/restore", validateToken, validateAdmin, restoreRoomController);
